var app = angular.module('myApp',[]);
		...
		//IF RESPONSE DATA IS ACCURATE, SAVE IT AND OUTPUT MESSAGE
			...
			var url = 'http://localhost:8080/UpdateSubject/?Address='+Q1+'&SQFT='+Q2+'&Condition='+Q4+'&Exterior='+Q3+'&GarageCap='+Q5+'&Kitchen='+Q6+'&Bathrooms='+Q7+
																				'&Flooring='+Q8+'&Fireplace='+Q9+'&varsum'
				var data = {
				Q1: Q1,
				Q2: Q2,
		...
		//FUNCTION TO CALL THE CMA TABLE
			...
			$scope.CallCMA = function(id) {
				$http.get("http://localhost:8080/CallCMA/"+id)
					.then(  function(response) {console.log(response);
						$scope.properties = response.data;}
									);};
									});